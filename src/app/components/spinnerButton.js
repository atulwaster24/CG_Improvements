...
export default function Spinner5() {
  return (
    <section className="">
      <button
        type="submit"
        className="rounded w-full border flex items-center gap-2 justify-center font-semibold border-primary bg-blue-700 p-2 text-white transition hover:bg-opacity-90"
      >
        <span>
          <svg
...
export function Spinner6() {
  return (
    <section className="">
      <button
        className="mt-4 flex gap-2 rounded-lg bg-[#FFAA33] py-2 px-2  font-semibold"
      >
        <span>
          <svg
            className="animate-spin"
