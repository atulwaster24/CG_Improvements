...
export default function   WarningToast({clicked}) {
  return (
    <section className="">
      <div className="mx-auto px-4 sm:container">
        <div className="flex justify-end">
          <div className="flex w-full max-w-[490px] items-center rounded-lg border border-[#F5C5BB] bg-[#FCEDEA] p-2">
            <div className="mr-5 flex h-[45px] w-full max-w-[45px] items-center justify-center rounded bg-[#EA4E2C] text-white sm:h-[60px] sm:max-w-[60px]">
              <svg viewBox="0 0 32 32" className="h-4 w-4 sm:h-8 sm:w-8">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            <div className="flex w-full items-center justify-between">
              <div>
                ...
                <p className="text-sm font-medium text-body-color">
                  Sorry! There was a problem sending message. Try mail.
                </p>
              </div>
              <button className="ml-2 flex h-7 w-7 items-center justify-center rounded bg-white text-body-color hover:bg-[#EA4E2C] hover:text-white" onClick={()=> clicked()}>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
