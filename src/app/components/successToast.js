...
export default function SuccessToast2({clicked}) {
  return (
    <section className="bg-gray-2 py-2">
      <div className="mx-auto px-4 sm:container">
        <div className="flex  justify-end">
          <div className="relative  bg-green-200/35 flex w-full max-w-[460px] items-center rounded-lg border border-green-400 bg-primary/5 px-5 py-[18px]">
            <span className="mr-4 flex h-[30px] w-full max-w-[30px] items-center justify-center border-2 border-green-400 rounded-full bg-primary">
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
